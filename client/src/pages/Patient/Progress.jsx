    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          {["Pain Level", "Mobility", "Strength"].map((title) => (
            <div key={title} className="h-56 bg-gray-50 rounded-lg flex flex-col items-center justify-center">
              <div className="text-4xl mb-2">📈</div>
              <p className="text-gray-500">{title} over time</p>
