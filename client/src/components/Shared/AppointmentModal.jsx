...
import { FiX, FiCalendar, FiClock, FiVideo, FiUser, FiMapPin, FiChevronDown } from 'react-icons/fi';
          ...
          >
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.div
                  initial={{ opacity: 0, x: currentStep > 1 ? -20 : 0 }}
                ...
                <motion.div
                  initial={{ opacity: 0, x: currentStep < 2 ? 20 : currentStep > 2 ? -20 : 0 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.3 }}
                ...
                <motion.div
                  initial={{ opacity: 0, x: currentStep < 3 ? 20 : 0 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.3 }}
