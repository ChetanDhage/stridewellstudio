...
//     therapist: {
//       name: ["Dr. Sarah", "Dr. Michael", "Dr. Emily"][Math.floor(Math.random() * 3)],
//       specialty: ["Orthopedic", "Sports Medicine", "Geriatric"][Math.floor(Math.random() * 3)]
//     },
//     equipment: ["None", "Resistance Band", "Yoga Mat"][Math.floor(Math.random() * 3)]
//   };
...
//       >
//         <FiHeart className="text-gray-400 group-hover:text-red-500 transition-colors duration-300" />
//       </button>
...
//         {/* Difficulty badge */}
//         <div className="absolute top-5 left-5 opacity-100 translate-x-0 transition-all delay-300">
//           <span className={`inline-flex items-center px-3 py-1.5 text-xs font-semibold rounded-full shadow-md ${
...
//             </div>
//             <div>
//               <p className="text-xs font-medium text-gray-900">{exerciseData.therapist.name}</p>
//               <p className="text-xs text-gray-500">{exerciseData.therapist.specialty}</p>
//             </div>
//           </div>
//         </div>
//       </div>
...
//           <h3 className="text-xl font-bold text-gray-900 leading-tight">{exerciseData.title}</h3>
...
//             <span className="text-xs font-medium text-yellow-800">{exerciseData.rating}</span>
//           </div>
//         </div>

//         <p className="text-gray-600 mb-5 text-sm leading-relaxed">{exerciseData.description}</p>
...
//             <span className="text-xs font-medium text-gray-700">{exerciseData.duration}</span>
//           </div>
//           <div className="bg-gray-50 p-2 rounded-xl text-center border border-gray-100 hover:bg-gray-100 transition-all">
//             <FiActivity className="mx-auto text-green-500 mb-1" />
//             <span className="text-xs font-medium text-gray-700">{exerciseData.calories} cal</span>
//           </div>
//           <div className="bg-gray-50 p-2 rounded-xl text-center border border-gray-100 hover:bg-gray-100 transition-all">
//             <FiBarChart2 className="mx-auto text-purple-500 mb-1" />
//             <span className="text-xs font-medium text-gray-700">{exerciseData.completed}+</span>
//           </div>
//         </div>
...
//               Requires: {exerciseData.equipment}
//             </span>
//           </div>
//         )}
...
//           <button
//             className="w-full flex items-center justify-center py-3.5 px-6 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all"
//           >
...
const ExerciseCard = ({ exercise, index, isFavorite, onToggleFavorite }) => {
